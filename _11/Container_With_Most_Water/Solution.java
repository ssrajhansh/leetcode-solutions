...
public class Solution {
    ...
    public int maxArea(int[] height) {
        ...
        while(i!=j){
            int tempArea = (height[i]>height[j]) ? (j-i)*(height[j--]) : (j-i)*(height[i++]);
